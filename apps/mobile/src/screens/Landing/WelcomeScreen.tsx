...
const communityFinanceImage = require('../../../assets/landing-merchant.png');

const featureCards = [
  {
    icon: 'finger-print-outline',
    title: 'AI Financial Identity',
    body: 'Create a trusted CUB profile from KYC, mobile money history, and verified repayment behavior.',
    tone: '#002853',
  },
  {
    icon: 'swap-horizontal-outline',
    title: 'P2P Lending',
    body: 'Request, negotiate, fund, and repay community loans with transparent status tracking.',
    tone: '#133E72',
  },
  {
    icon: 'people-outline',
    title: 'Guardian Support',
    body: 'Enable legally clear guardian flows for minors and supported family financial accounts.',
    tone: '#735C00',
  },
];
      ...
      >
        <View style={styles.topBar}>
          <View style={styles.brandRow}>
            ...
            <Text style={styles.brandText}>CUB</Text>
          </View>
        ...
        <View style={styles.heroImageWrap}>
          <Image source={communityFinanceImage} style={styles.heroImage} resizeMode="cover" />
          <View style={styles.aiPill}>
            <Ionicons name="flash" size={rs(18)} color="#FFFFFF" />
            <Text style={styles.aiPillText}>AI Financial Identity</Text>
          </View>
          <View style={styles.growthCard}>
            ...
            <View>
              <Text style={styles.growthLabel}>CREDIT READY</Text>
              <Text style={styles.growthValue}>Score 740</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.trustBadge}>
          ...
          <Text style={styles.trustBadgeText}>Built for Cameroonian borrowers, lenders, and families</Text>
        </View>

        <View style={styles.heroCopy}>
          <Text style={styles.heroTitle}>
            Build Your Financial Future with <Text style={styles.heroTitleAccent}>CUB</Text>
          </Text>
          <Text style={styles.heroBody}>
            Cameroon Union Bank turns identity, mobile money history, and community trust into fair access to credit.
          </Text>
        </View>

        <View style={styles.actions}>
          <TouchableOpacity style={styles.primaryButton} activeOpacity={0.88} onPress={() => openAuth('Register')}>
            <LinearGradient colors={['#002853', '#133E72']} style={styles.primaryButtonBg} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}>
        ...
        <View style={styles.financeSection}>
          <Text style={styles.sectionTitleCenter}>Designed for modern community finance</Text>
          <Text style={styles.sectionIntro}>
            Built for fast KYC, clear lending decisions, responsible repayments, and lender visibility.
          </Text>
        ...
        <View style={styles.securitySection}>
          <Text style={styles.securityTitle}>A secure path from identity to credit</Text>
          <View style={styles.securityItems}>
            <View style={styles.securityItem}>
              ...
              <View style={styles.securityCopy}>
                ...
                <Text style={styles.securityItemBody}>Your identity, loan, and repayment data is protected with bank-grade security protocols.</Text>
              </View>
            </View>
            <View style={styles.securityItem}>
              <View style={styles.checkIcon}>
              ...
              <View style={styles.securityCopy}>
                <Text style={styles.securityItemTitle}>Mobile Money Ready</Text>
                <Text style={styles.securityItemBody}>Use MTN Mobile Money and Orange Money data to strengthen your financial profile.</Text>
              </View>
            </View>
          </View>
        </View>

        <LinearGradient colors={['#002853', '#133E72']} style={styles.communityCard}>
          ...
          <Text style={styles.communityTitle}>Join a trusted Cameroonian credit community.</Text>
        ...
        <View style={styles.footer}>
          <View style={styles.footerBrand}>
            ...
            <Text style={styles.footerBrandText}>Cameroon Union Bank</Text>
          </View>
          <Text style={styles.footerText}>2026 Cameroon Union Bank. Built in Cameroon.</Text>
...
const styles = StyleSheet.create({
  ...
  growthIcon: { width: rs(44), height: rs(44), borderRadius: rs(22), backgroundColor: '#F0D980', alignItems: 'center', justifyContent: 'center' },
  ...
  financeSection: { backgroundColor: '#EAF1F8', paddingTop: rs(56), paddingHorizontal: rs(20), paddingBottom: rs(54) },
  ...
  faceBubble: { width: rs(42), height: rs(42), borderRadius: rs(21), alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: '#002853' },
  ...
  footer: { backgroundColor: '#EAF1F8', alignItems: 'center', paddingTop: rs(30), paddingBottom: rs(34), paddingHorizontal: rs(20) },
