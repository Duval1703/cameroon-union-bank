    ...
    <View style={styles.screen}>
      ...
      >
        <View style={styles.headerTop}>
          ...
          <Text style={styles.brand}>CUB Inventory AI</Text>
        </View>
        <Text style={styles.title}>Smart Inventory</Text>
        <Text style={styles.subtitle}>
          Capture stock by photo or speak naturally. CUB structures the data for your records.
        </Text>
      </LinearGradient>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.actionGrid}>
          <TouchableOpacity style={styles.actionCard} onPress={captureInventoryPhoto} activeOpacity={0.85}>
            <LinearGradient colors={['#133E72', '#059669']} style={styles.actionIcon}>
        ...
        <View style={styles.voiceCard}>
          <View style={styles.voiceHeader}>
            <Ionicons name="pulse-outline" size={rs(18)} color="#002853" />
        ...
        <View style={styles.savedTablesCard}>
          <View style={styles.savedTablesHeader}>
            ...
            <TouchableOpacity style={styles.refreshTablesBtn} onPress={loadSavedTables} activeOpacity={0.8}>
              <Ionicons name="refresh" size={rs(16)} color="#002853" />
            </TouchableOpacity>
          </View>

          {savedTables.length === 0 ? (
            <View style={styles.emptySavedTableBox}>
              <Ionicons name="albums-outline" size={rs(19)} color="#002853" />
                ...
                <View key={table.id} style={styles.savedTableItem}>
                  ...
                  >
                    <View style={styles.savedTableIcon}>
                      <Ionicons name="grid-outline" size={rs(16)} color="#002853" />
                    </View>
              ...
              <View style={styles.tableCard}>
                <View style={styles.reviewToolbar}>
                  ...
                  <TouchableOpacity style={styles.addRowBtn} onPress={addRow} activeOpacity={0.85}>
                    <Ionicons name="add" size={rs(16)} color="#002853" />
...
const styles = StyleSheet.create({
  ...
  actionCta: { marginTop: rs(8), color: '#002853', fontSize: FontSize.sm, fontWeight: FontWeight.bold },
  ...
  transcriptInput: { minHeight: rs(92), borderWidth: 1.5, borderColor: '#DCE7F3', borderRadius: Radius.lg, padding: rs(12), textAlignVertical: 'top', fontSize: FontSize.base, color: '#111827', backgroundColor: '#F8FAFC' },
  languagePills: { flexDirection: 'row', flexWrap: 'wrap', gap: rs(7) },
  langPill: { backgroundColor: '#EEF3F8', paddingHorizontal: rs(10), paddingVertical: rs(5), borderRadius: Radius.full },
  langPillActive: { backgroundColor: '#002853' },
  langText: { fontSize: FontSize.xs, color: '#002853', fontWeight: FontWeight.semibold },
  langTextActive: { color: '#FFFFFF' },
  digitalizeBtn: { marginTop: rs(4), height: rs(46), borderRadius: Radius.full, backgroundColor: '#002853', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: rs(8) },
  ...
  refreshTablesBtn: { width: rs(36), height: rs(36), borderRadius: rs(18), backgroundColor: '#EEF3F8', alignItems: 'center', justifyContent: 'center' },
  emptySavedTableBox: { flexDirection: 'row', alignItems: 'center', gap: rs(8), backgroundColor: '#F4F7FB', borderRadius: Radius.md, padding: rs(10), borderWidth: 1, borderColor: '#DCE7F3' },
  emptySavedTableText: { flex: 1, fontSize: FontSize.sm, color: '#002853', lineHeight: rs(18) },
  savedTableItem: { borderWidth: 1, borderColor: '#E5E7EB', borderRadius: Radius.lg, overflow: 'hidden', backgroundColor: '#FFFFFF' },
  savedTableSummary: { flexDirection: 'row', alignItems: 'center', gap: rs(10), padding: rs(10) },
  savedTableIcon: { width: rs(34), height: rs(34), borderRadius: rs(17), backgroundColor: '#EEF3F8', alignItems: 'center', justifyContent: 'center' },
  ...
  savedTableScroll: { borderTopWidth: 1, borderTopColor: '#E5E7EB' },
  ...
  tableCard: { borderWidth: 1, borderColor: '#DCE7F3', borderRadius: Radius.lg, overflow: 'hidden', backgroundColor: '#FFFFFF' },
  reviewToolbar: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: rs(10), padding: rs(10), borderBottomWidth: 1, borderBottomColor: '#E5E7EB', backgroundColor: '#F8FAFC' },
  reviewCopy: { flex: 1 },
  ...
  addRowBtn: { flexDirection: 'row', alignItems: 'center', gap: rs(4), paddingHorizontal: rs(10), paddingVertical: rs(7), borderRadius: Radius.full, backgroundColor: '#EEF3F8', borderWidth: 1, borderColor: '#DCE7F3' },
  addRowText: { color: '#002853', fontSize: FontSize.xs, fontWeight: FontWeight.bold },
  tableScroll: { maxWidth: '100%' },
  tableRow: { flexDirection: 'row', minHeight: rs(46), borderBottomWidth: 1, borderBottomColor: '#E5E7EB', alignItems: 'center' },
  tableHeaderRow: { minHeight: rs(38), backgroundColor: '#EEF3F8' },
  tableHeaderText: { color: '#002853', fontWeight: FontWeight.bold, fontSize: FontSize.xs },
  ...
  saveReviewedBtn: { margin: rs(10), height: rs(44), borderRadius: Radius.full, backgroundColor: '#002853', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: rs(8) },
  ...
  confidenceNote: { padding: rs(9), fontSize: FontSize.xs, color: '#6B7280', backgroundColor: '#F8FAFC' },
  ...
  itemIcon: { width: rs(34), height: rs(34), borderRadius: rs(17), backgroundColor: '#EEF3F8', alignItems: 'center', justifyContent: 'center' },
  ...
  savedBox: { flexDirection: 'row', alignItems: 'center', gap: rs(7), backgroundColor: '#EEF3F8', padding: rs(10), borderRadius: Radius.md },
  savedText: { flex: 1, fontSize: FontSize.sm, color: '#002853', fontWeight: FontWeight.semibold },
});
